...
class ClientCookieTest extends \PHPUnit_Framework_TestCase {
    /** @var Client */
    private $client;
    ...
    public function setUp() {
        ...
        $this->client = new Client(\Amp\getReactor(), $this->jar);
    }

    /** @dataProvider provideCookieDomainMatchData */
    public function testCookieAccepting(Cookie $cookie, $requestDomain, $accept) {
