...
use Artax\Negotiation\Negotiators\CharsetNegotiator,
    Artax\Negotiation\Parsers\AcceptCharsetParser;

class CharsetNegotiatorTest extends PHPUnit_Framework_TestCase {
    
    /**
     * @covers Artax\Negotiation\Negotiators\CharsetNegotiator::__construct
     */
    public function testBeginsEmpty() {
        $negotiator = new CharsetNegotiator(new AcceptCharsetParser);
        $this->assertInstanceOf(
            'Artax\\Negotiation\\Negotiators\\CharsetNegotiator', $negotiator
        );
    }
    
    /**
     * @covers Artax\Negotiation\Negotiators\CharsetNegotiator::negotiate
     */
