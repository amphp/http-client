...
class MediaRangeTermTest extends PHPUnit_Framework_TestCase {
     ...
     * @covers Artax\Http\Negotiation\MediaRangeTerm::__construct
     */
    public function testConstructorInitializesProperties($pos, $type, $quality, $explicit) {
        ...
        $this->assertInstanceOf('Artax\\Http\\Negotiation\\MediaRangeTerm', $term);
    }
    
    /**
     * @dataProvider providesValidTermConstructorArgs
     * @covers Artax\Http\Negotiation\MediaRangeTerm::__toString
     */
    ...
    /**
     * @dataProvider providesValidTermConstructorArgs
     * @covers Artax\Http\Negotiation\MediaRangeTerm::getType
     */
    ...
    /**
     * @dataProvider providesValidTermConstructorArgs
     * @covers Artax\Http\Negotiation\MediaRangeTerm::getRangeTopLevelType
     */
    ...
    /**
     * @dataProvider providesValidTermConstructorArgs
     * @covers Artax\Http\Negotiation\MediaRangeTerm::getRangeSubType
     */
    ...
    /**
     * @dataProvider providesValidTermConstructorArgs
     * @covers Artax\Http\Negotiation\MediaRangeTerm::getRangeSuffix
     */
    ...
    /**
     * @dataProvider providesValidTermConstructorArgs
     * @covers Artax\Http\Negotiation\MediaRangeTerm::isRangeExperimental
     */
    ...
    /**
     * @dataProvider providesValidTermConstructorArgs
     * @covers Artax\Http\Negotiation\MediaRangeTerm::rangeMatches
     */
